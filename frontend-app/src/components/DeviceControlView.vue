    ...
    <section class="device-layout">
      <div class="card p-24">
        ...
        <div class="actions-grid">
          ...
          >
            {{ pendingCommand === 'wake' ? 'Отправляем...' : 'Разбудить устройство' }}
          </button>
          ...
          >
            {{ pendingCommand === 'sleep' ? 'Отправляем...' : 'Перевести в сон' }}
          </button>
      ...
      <div class="card p-24">
        ...
        <div class="helper settings-subtitle">
          Настройка периодов для отдельных типов данных устройства.
        </div>
...
function extractErrorMessage(e, fallback = 'Ошибка отправки команды') {
